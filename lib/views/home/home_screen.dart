...
import '../booking/booking_screen.dart'; // this file contains SelectServiceScreen
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    Row(
                      children: [
                        _QuickActionCard(
                          ...
                          onTap: _openBooking, // ✅ opens SelectServiceScreen
                        ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 1) {
            _openBooking(); // ✅ opens SelectServiceScreen
